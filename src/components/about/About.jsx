...
import "./About.css";
// import CV from "../../assets/1 Page Resume 2022 New v2.pdf";
        ...
        <section className="about section" id="about"> 
            ...
            <div className="about__container container grid">
                ...
                <div className="about__intro">
                    ...
                    <h3 className="about__answer right-hidden">I design + develop websites, apps, automation scripts and IoT projects.</h3>
                </div>
